...
namespace ASGI {
	...
	enum BufferUsageFlags {
		BUFFER_USAGE_STATIC = 0x00000001,
		BUFFER_USAGE_DYNAMIC = 0x00000002
	};

	enum ImageUsageFlagBits {
		IMAGE_USAGE_SAMPLED_BIT = 0x00000001, //0x00000004
		IMAGE_USAGE_STORAGE_BIT = 0x00000002, //0x00000008
		IMAGE_USAGE_COLOR_ATTACHMENT_BIT = 0x0000004, //0x00000010
		IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT = 0x0000008, //0x00000020
		IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT = 0x00000010, //0x00000040
		IMAGE_USAGE_INPUT_ATTACHMENT_BIT = 0x00000020 //0x00000080
	};
