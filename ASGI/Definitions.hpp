...
namespace ASGI {
	const uint32_t SUBPASS_EXTERNAL = ~0U;
	...
	enum MapMode {
		MAP_MODE_READ = ACCESS_HOST_READ_BIT,
		MAP_MODE_WRITE = ACCESS_HOST_WRITE_BIT,
		MAP_MODE_READ_WRITE = MAP_MODE_READ | MAP_MODE_WRITE
	};

	enum BufferUsageFlagBits {
		BUFFER_USAGE_TRANSFER_SRC_BIT = 0x00000001,
		BUFFER_USAGE_TRANSFER_DST_BIT = 0x00000002,
		BUFFER_USAGE_UNIFORM_TEXEL_BIT = 0x00000004,
		BUFFER_USAGE_STORAGE_TEXEL_BIT = 0x00000008,
		BUFFER_USAGE_UNIFORM_BIT = 0x00000010,
		BUFFER_USAGE_STORAGE_BIT = 0x00000020,
		BUFFER_USAGE_INDEX_BIT = 0x00000040,
		BUFFER_USAGE_VERTEX_BIT = 0x00000080,
		BUFFER_USAGE_INDIRECT_BIT = 0x00000100,
		BUFFER_USAGE_UPLOAD = 0x00000200,
		BUFFER_USAGE_READBACK = 0x00000400
	};
	...
	enum ImageUsageFlagBits {
		...
		IMAGE_USAGE_UPLOAD = 0x000000100,
		IMAGE_USAGE_READBACK = 0x000000200
	};
	...
	enum QueueType {
		QUEUE_TYPE_GRAPHICS = 0x00000001,
		QUEUE_TYPE_COMPUTE = 0x00000002
	};
}
